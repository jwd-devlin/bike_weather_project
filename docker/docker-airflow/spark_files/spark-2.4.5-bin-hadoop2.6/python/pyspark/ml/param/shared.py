...
class HasTol(Params):
    ...
    tol = Param(Params._dummy(), "tol", "the convergence tolerance for iterative algorithms (>= 0).",
                typeConverter=TypeConverters.toFloat)
...
class HasStepSize(Params):
    ...
    stepSize = Param(Params._dummy(), "stepSize", "Step size to be used for each iteration of optimization (>= 0).",
                     typeConverter=TypeConverters.toFloat)
...
class HasStandardization(Params):
    ...
    standardization = Param(Params._dummy(), "standardization",
...
class HasThreshold(Params):
    ...
    threshold = Param(Params._dummy(), "threshold", "threshold in binary classification prediction, in range [0, 1]",
                      typeConverter=TypeConverters.toFloat)
...
class HasSolver(Params):
    ...
    solver = Param(Params._dummy(), "solver",
...
class HasVarianceCol(Params):
    ...
    varianceCol = Param(Params._dummy(), "varianceCol", "column name for the biased sample variance of prediction.",
                        typeConverter=TypeConverters.toString)
...
class HasAggregationDepth(Params):
    ...
    aggregationDepth = Param(Params._dummy(), "aggregationDepth", "suggested depth for treeAggregate (>= 2).",
                             typeConverter=TypeConverters.toInt)
...
class DecisionTreeParams(Params):
    ...
    maxDepth = Param(Params._dummy(), "maxDepth",
                     ...
                     typeConverter=TypeConverters.toInt)
    maxBins = Param(Params._dummy(), "maxBins",
    ...
    minInstancesPerNode = Param(Params._dummy(), "minInstancesPerNode",
                                ...
                                typeConverter=TypeConverters.toInt)
    minInfoGain = Param(Params._dummy(), "minInfoGain",
    ...
    maxMemoryInMB = Param(Params._dummy(), "maxMemoryInMB",
                          ...
                          typeConverter=TypeConverters.toInt)
    cacheNodeIds = Param(Params._dummy(), "cacheNodeIds",
...
class HasDistanceMeasure(Params):
    ...
    distanceMeasure = Param(Params._dummy(), "distanceMeasure",
